...
$id=0;
if(isset($_GET['ccc'])){
  $id = filter_var($_GET['ccc'],FILTER_SANITIZE_NUMBER_INT);
}
?>
<!DOCTYPE html>
<html>
  ...
  <body class="hold-transition register-page">
    <div class="register-box">
        <div class="register-logo">
            <a href="consolas.php"> <img class="center-block " src="../Public/img/logo.png" width="250px" height="100px"> </a>
        </div>
        <div class="register-box-body">
            ...
            <form id="frmRegistrar">
              ...
              <div class="form-group has-feedback">
                <select name="plataforma[]" id="plataforma" class="form-control" multiple="multiple">
                </select>
                <p id="alerta_plataforma" style="display:none;">*El campo <b>Plataforma</b> es obligatorio.</p>
              </div>
              <div class="form-group has-feedback">
                <input type="text" class="form-control" placeholder="Numero" name="numero" id="numero" maxlength="5">
                <span class="glyphicon glyphicon-user form-control-feedback"></span>
                <p id="alerta_numero" style="display:none;">*El campo <b>Numero</b> es obligatorio.</p>
              </div>
              <div class="form-group has-feedback">
                <input type="text" class="form-control" placeholder="Serial" name="serial" id="serial" maxlength="20">
                <span class="glyphicon glyphicon-user form-control-feedback"></span>
                <p id="alerta_serial" style="display:none;">*El campo <b>Serial</b> es obligatorio.</p>
              </div>
              <div class="form-group has-feedback">
                <label for="costo">Costo:</label>
                <input type="number" placeholder="Costo" class="form-control" name="costo" id="costo" min="1">
              ...
              <div class="form-group has-feedback">
                <label for="costo">Costo en monedas:</label>
                <input type="number" placeholder="Costo en monedas" class="form-control" name="costoMon" id="costoMon" min="1" step="1">
                <span class="glyphicon glyphicon-euro form-control-feedback"></span>
                <p id="alerta_costoMon" style="display:none;">*El campo <b>Costo en monedas</b> es obligatorio.</p>
              </div>
              <div class="form-group has-feedback">
                <label for="costo">Monedas dadas:</label>
            ...
            <hr>
            <a id="regresarbtn" href="consolas.php" class="text-center btn btn-success btn-block"> <p> Regresar </p> </a>
        </div>
    </div>
    <!-- jQuery UI 1.11.4 -->
    ...
    <script type="text/javascript">
      $(document).ready(function(){
        $.ajax({
          url: '../plataformas/getPlataformas_.php',
          type: 'POST',
          dataType:'json',
          async: false,
          cache: false,
          ...
          success: function (returndata) {
            ...
            if(returndata[0].error==0){
              ...
              for (var i=0; i<returndata[1].length; i++) {
                $("#plataforma").append('<option value="'+returndata[1][i].idPlataforma+'">'+returndata[1][i].nombre+'</option>');
              }
            }else{
          ...
          $.ajax({
            ...
            success: function (returndata) {
              ...
              if(returndata[0].error==0){
                ...
                $("#costoMon").val(returndata[1][0].costoMonedas);
        ...
        $('#plataforma').multiselect({
          numberDisplayed: 3,
          buttonText: function(options, select) {
            if (options.length === 0) {
              return 'Plataformas';
            }else if (options.length > 3) {
              return options.length+' plataformas seleccionadas';
            }else {
              var labels = [];
