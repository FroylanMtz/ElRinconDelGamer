...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div class="row">
      ...
      <div class="col-xs-2">
          <a href="addConsola.php" class="btn btn-success btn-block boton" style="">Nuevo</a>
      </div>
    </div>
    ...
    $.ajax({
      ...
      success: function (returndata) {
        ...
        if(returndata[0].error==0){
          ...
          rJson = rJson + " <thead> <tr> <th>Consola</th> <th>Plataforma</th> <th>Número</th> <th>Serial</th> <th>Costo ($ X hr)</th> <th>Costo en monedas (hr)</th> <th>Monedas dadas (hr)</th> <th>Editar</th> <th>Eliminar</th> </tr> </thead> ";
          for (i = 0; i < returndata[1].length; i++) {
            rJson = rJson + " <tbody>  <tr id='tr"+returndata[1][i].idConsola+"'><td>" + returndata[1][i].nombre + "</td><td>" + returndata[1][i].nombrePla + "</td><td>" + returndata[1][i].numero + "</td><td>" + returndata[1][i].seriall + "</td><td>" + returndata[1][i].costo + "</td><td>" + returndata[1][i].costoMonedas + "</td><td>" + returndata[1][i].premioMonedas + "</td>";
            rJson = rJson + "<th><a href='addConsola.php?ccc="+returndata[1][i].idConsola+"' target='_self' class='btn btn-primary btn-block boton'>EDITAR</a></th>";
            rJson = rJson + "<th><a href='#' target='_self' data-id='"+returndata[1][i].idConsola+"' class='link_eliminar btn btn-danger btn-block boton'>ELIMINAR</a></th>";
            rJson = rJson + "</tr>";
          }
                ...
                success: function (returndata) {
                  if(returndata == 1){
                    swal.fire({
                      ...
                      text: "Una consola fue eliminada con éxito.",
