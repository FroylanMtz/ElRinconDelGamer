  ...
  <body class="hold-transition register-page">
    <div class="register-box">
        <div class="register-logo">
            <a href="premios.php"> <img class="center-block " src="../Public/img/logo.png" width="250px" height="100px"> </a>
        </div>
        <div class="register-box-body">
            <h4> <p class="login-box-msg"> Registro de premios </p> </h4>
            <form id="frmRegistrar">
              <div class="form-group has-feedback">
                <select class="form-control" name="torneo" id="torneo">
                    <option value="0"> Torneo </option>
                </select>
                <p id="alerta_torneo" style="display:none;">*El campo <b>Torneo</b> es obligatorio.</p>
              </div>
              <div class="form-group has-feedback">
                <input type="text" class="form-control" placeholder="Premio del primer lugar" name="premio1" id="premio1" maxlength="100">
                <span class="glyphicon glyphicon-hdd form-control-feedback"></span>
                <p id="alerta_premio1" style="display:none;">*El campo <b>Premio del primer lugar</b> es obligatorio.</p>
              </div>
              <div class="form-group has-feedback">
                <input type="text" class="form-control" placeholder="Premio del segundo lugar" name="premio2" id="premio2" maxlength="100">
                <span class="glyphicon glyphicon-hdd form-control-feedback"></span>
                <p id="alerta_premio2" style="display:none;">*El campo <b>Premio del segundo lugar</b> es obligatorio.</p>
              </div>
              <div class="form-group has-feedback">
                <input type="text" class="form-control" placeholder="Premio del tercer lugar" name="premio3" id="premio3" maxlength="100">
                <span class="glyphicon glyphicon-hdd form-control-feedback"></span>
                <p id="alerta_premio3" style="display:none;">*El campo <b>Premio del tercer lugar</b> es obligatorio.</p>
              </div>
              <div class="row">
                <div class="col-xs-12">
            ...
            <hr>
            <a id="regresarbtn" href="premios.php" class="text-center btn btn-success btn-block"> <p> Regresar </p> </a>
        </div>
    </div>
    <!-- jQuery 3 -->
        ...
        $.ajax({
          ...
          success: function (returndata) {
            ...
            if(returndata[0].error==0){
              $("#torneo").empty();
              $("#torneo").append('<option value="0"> Torneo </option>');
              for (var i=0; i<returndata[1].length; i++) {
                $("#torneo").append('<option value="'+returndata[1][i].idTorneo+'">'+returndata[1][i].titulo+' ('+returndata[1][i].nombreJue+')'+'</option>');
              }
            }else{
