...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div class="row">
      ...
      <div class="col-xs-2">
          <a href="addRenta.php" class="btn btn-success btn-block boton" style="">Nuevo</a>
      </div>
    </div>
    ...
    $.ajax({
      ...
      success: function (returndata) {        
        ...
        if(returndata[0].error==0){
          ...
          rJson = rJson + " <thead> <tr> <th>Usuario</th> <th>Consola</th> <th>Juego</th> <th>Fecha</th> <th>Hora</th> <th>Promoción</th> <th>Pagar</th>  </tr> </thead> ";
          for (i = 0; i < returndata[1].length; i++) {
            ...
            rJson = rJson + "<th><a href='addRenta.php?rrr="+returndata[1][i].idRenta+"' target='_self' class='btn btn-primary btn-block boton'>Pagar</a></th>";
            rJson = rJson + "</tr>";
          }
