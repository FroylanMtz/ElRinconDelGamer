  ...
  <body class="hold-transition register-page">
    <div class="register-box">
        <div class="register-logo">
            <a href="usuarios.php"> <img class="center-block " src="../Public/img/logo.png" width="250px" height="100px"> </a>
        </div>
        <div class="register-box-body">
            <h4> <p class="login-box-msg"> Monedas referencia usuario </p> </h4>
            <form id="frmRegistrar">
              <div class="form-group has-feedback">
                <input type="number" class="form-control" placeholder="Monedas referencia" name="monedas" id="monedas" min="0">
                <span class="glyphicon glyphicon-euro form-control-feedback"></span>
                <p id="alerta_monedas" style="display:none;">*El campo <b>Monedas referencia</b> es obligatorio.</p>
              </div>
              <div class="row">
                <div class="col-xs-12">
            ...
            <hr>
            <a id="regresarbtn" href="usuarios.php" class="text-center btn btn-success btn-block"> <p> Regresar </p> </a>
        </div>
    </div>
    <!-- jQuery 3 -->
        ...
        $.ajax({
          ...
          success: function (returndata) {
            ...
            if(returndata[0].error==0){
              $("#monedas").val(returndata[1][0].monedasReferencia);
            }else{
