...
<script type="text/javascript">
  $(document).ready(function(){
      ...
      success: function (returndata) {
        ...
        if(returndata[0].error==0){
          ...
          for (i = 0; i < returndata[1].length; i++) {
            ...
            rJson = rJson + "<th><a href='#' target='_self' data-id='"+returndata[1][i].idEquipo+"' class='link_aceptar btn btn-primary btn-block boton'>Aceptar</a></th>";
            rJson = rJson + "</tr>";
          }
    ...
    jQuery(document).on('click','.link_aceptar', function() {
      var id=$(this).data("id");
      console.log(id);
      swal.fire({
        icon: "warning",
            ...
            success: function (returndata) {
              if(returndata == 1){
                swal.fire({
                  ...
                  text: "La invitación fue aceptada con éxito.",
