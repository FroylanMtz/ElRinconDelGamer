...
$id=0;
if(isset($_GET['ap'])){
  $id = filter_var($_GET['ap'],FILTER_SANITIZE_NUMBER_INT);
}
?>
<!DOCTYPE html>
<html>
            ...
            <form id="frmRegistrar">
              <div class="form-group has-feedback">
                <select class="form-control" name="equipo1" id="equipo1">
                    <option value="0">  Equipo ganador primer lugar  </option>
                </select>
                <p id="alerta_equipo1" style="display:none;">*El campo <b>Premio del primer lugar</b> es obligatorio.</p>
              </div>
              <div class="form-group has-feedback">
                <select class="form-control" name="equipo2" id="equipo2">
                    <option value="0">  Equipo ganador segundo lugar  </option>
                </select>
                <p id="alerta_equipo2" style="display:none;">*El campo <b>Premio del segundo lugar</b> es obligatorio.</p>
              </div>
              <div class="form-group has-feedback">
                <select class="form-control" name="equipo3" id="equipo3">
                    <option value="0"> Equipo ganador tercer lugar </option>
                </select>
                <p id="alerta_equipo3" style="display:none;">*El campo <b>Premio del tercer lugar</b> es obligatorio.</p>
              </div>
              <div class="row">
                <div class="col-xs-12">
