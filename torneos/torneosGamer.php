      ...
      success: function (returndata) {
        ...
        if(returndata[0].error==0){
          ...
          for (i = 0; i < returndata[1].length; i++) {
            if(returndata[1][i].idUsuario != idUs) {
              ...
              rJson = rJson + "<th><a href='registrarEnTorneo.php?rev="+returndata[1][i].idTorneo+"' target='_self' class='btn btn-primary btn-block boton'>Registrarse</a></th>";
              rJson = rJson + "</tr>";
            }
          }
