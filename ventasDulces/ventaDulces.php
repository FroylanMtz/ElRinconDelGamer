...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div class="row">
      ...
      <div class="col-xs-2">
          <a href="addVentaDulces.php" class="btn btn-success btn-block boton" style="">Nuevo</a>
      </div>
    </div>
    ...
    $.ajax({
      ...
      success: function (returndata) {
        ...
        if(returndata[0].error==0){
          ...
          rJson = rJson + " <thead> <tr> <th>Dulce</th> <th>Usuario</th> <th>Cantidad</th> </thead> ";
          for (i = 0; i < returndata[1].length; i++) {
            rJson = rJson + " <tbody>  <tr><td>" + returndata[1][i].nombre + "</td><td>" + returndata[1][i].usuario + "</td><td>" + returndata[1][i].cantidad + "</td>";
            rJson = rJson + "</tr>";
          }
