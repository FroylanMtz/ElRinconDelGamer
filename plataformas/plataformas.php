...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div class="row">
      ...
      <div class="col-xs-2">
          <a href="addPlataforma.php" class="btn btn-success btn-block boton" style="">Nuevo</a>
      </div>
    </div>
    ...
    $.ajax({
      ...
      success: function (returndata) {
        ...
        if(returndata[0].error==0){
          ...
          rJson = rJson + " <thead> <tr> <th>Nombre</th><th style='width:18%;'>Editar</th> <th style='width:18%;'>Eliminar</th> </tr> </thead> ";
          for (i = 0; i < returndata[1].length; i++) {
            rJson = rJson + " <tbody>  <tr id='tr"+returndata[1][i].idPlataforma+"'><td>" + returndata[1][i].nombre + "</td>";
            rJson = rJson + "<th><a href='addPlataforma.php?ppp="+returndata[1][i].idPlataforma+"' target='_self' class='btn btn-primary btn-block boton'>EDITAR</a></th>";
            rJson = rJson + "<th><a href='#' target='_self' data-id='"+returndata[1][i].idPlataforma+"' class='link_eliminar btn btn-danger btn-block boton'>ELIMINAR</a></th>";
            rJson = rJson + "</tr>";
          }
                ...
                success: function (returndata) {
                  if(returndata == 1){
                    swal.fire({
                      ...
                      text: "Una plataforma fue eliminada con éxito.",
