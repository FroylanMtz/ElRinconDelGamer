  ...
  <body class="hold-transition register-page">
    <div class="register-box">
        <div class="register-logo">
            <a href="rentasAccesorios.php" id="logo"> <img class="center-block " src="../Public/img/logo.png" width="250px" height="100px"> </a>
        </div>
        <div class="register-box-body">
            ...
            <form id="frmRegistrar">
              ...
              <div class="form-group has-feedback">
                ...
                <p id="alerta_accesorio" style="display:none;">*El campo <b>Accesorio</b> es obligatorio.</p>
              </div>
              <div class="form-group has-feedback">
                <input type="number" class="form-control" placeholder="Número de horas" name="nHoras" id="nHoras" min="1" step="1">
                <span class="glyphicon glyphicon-euro form-control-feedback"></span>
                <p id="alerta_nHoras" style="display:none;">*El campo <b>Número de horas</b> es obligatorio.</p>
              </div>
              <div class="row">
                <div class="col-xs-12">
            ...
            <hr>
            <a id="regresarbtn" href="rentasAccesorios.php" class="text-center btn btn-success btn-block"> <p> Regresar </p> </a>
        </div>
    </div>
    <!-- jQuery 3 -->
    ...
    <script type="text/javascript">
      $(document).ready(function(){
        ...
        $.ajax({
          url: '../accesorios/getAccesorios_.php',
          type: 'POST',
          dataType:'json',
          async: false,
          cache: false,
          ...
          success: function (returndata) {
            ...
            if(returndata[0].error==0){
              $("#accesorio").empty();
              $("#accesorio").append('<option value="0"> Accesorios </option>');
              for (var i=0; i<returndata[1].length; i++) {
                $("#accesorio").append('<option value="'+returndata[1][i].idAccesorio+'">'+returndata[1][i].nombre+'</option>');
              }
            }else{
                var rError=returndata[1];
                $("#resultadoJson").html(rError);
