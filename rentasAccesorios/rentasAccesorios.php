...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div class="row">
      ...
      <div class="col-xs-2">
          <a href="addRentaAccesorio.php" class="btn btn-success btn-block boton" style="">Nuevo</a>
      </div>
    </div>
    <div class="contenedortabla">
        <h3><i class="fa fa-users"></i>
        Rentas de accesorios</h3>
    ...
    $.ajax({
      ...
      success: function (returndata) {
        ...
        if(returndata[0].error==0){
          ...
          rJson = rJson + " <thead> <tr> <th>Accesorio</th> <th>Usuario</th> <th>Número de horas</th> </thead> ";
          for (i = 0; i < returndata[1].length; i++) {
            rJson = rJson + " <tbody>  <tr><td>" + returndata[1][i].nombre + "</td><td>" + returndata[1][i].usuario + "</td><td>" + returndata[1][i].nHoras + "</td>";
            rJson = rJson + "</tr>";
          }
